          ...
          <div className="grid grid-rows-1 gap-16 place-items-center">
            ...
            <div className="grid grid-cols-1 gap-8 text-center md:grid-cols-2 md:gap-12">
              <Card className="w-full md:w-126 h-72 p-8 mb-4">
                ...
                <div className="card-content">
                  See and Manage all the support tickets that you have raised
                  with us.
                </div>
                <div className="card-footer">
                  <Button
              ...
              <Card className="w-full md:w-126 h-72 p-8 mb-4">
                ...
                <div className="card-content">
                  Have questions on Tax Filings? Our comprehensive set of
                  Guides, How-to articles and FAQs will help you.
                </div>
                <div className="card-footer">
                  <Button
                    className="btn btn-primary bg-blue-50/5 hover:text-blue-600 hover:bg-blue-50/5 text-blue-500"
