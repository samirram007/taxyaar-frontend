...
const ForeignCustodialAccountsEdit = () => {
  const router = useRouter()
  const location = useLocation()
  const pathSegments = location.pathname.split('/')
  const id = pathSegments[pathSegments.length - 1]
  const { getAccountById, updateAccount } = useCustodialAccount()
  ...
  const handleSave = () => {
    ...
    updateAccount(parseInt(id), data)
            ...
            <div className={cardClassName}>
              ...
              <div className="space-y-6 px-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <Label className="block text-sm font-medium text-foreground mb-2">
                      Peak Balance <span className="text-red-500">*</span>
                    </Label>
                    <Input
                      type="number"
                      placeholder="0"
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="authority-holder">
                          Authority Holder
                        </SelectItem>
                      </SelectContent>
                    </Select>
                ...
                <div>
                  <Label className="block text-sm font-medium text-foreground mb-2">
                    Gross Amount Paid <span className="text-red-500">*</span>
                  </Label>
                  <Input
                    type="number"
                    placeholder="0"
                    value={formData.grossAmountPaid}
                    onChange={(e) =>
                      handleChange('grossAmountPaid', e.target.value)
                    }
                  />
                </div>
                ...
                <div className="flex gap-4 pt-6">
                  ...
                  <CancelButton to="/foreign_custodial_accounts" />
                </div>
...
export default ForeignCustodialAccountsEdit
