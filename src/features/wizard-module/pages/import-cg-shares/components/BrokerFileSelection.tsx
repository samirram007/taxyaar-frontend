...
export default function BrokerFileSelection({
  ...
  return (
    <div className="flex-1 bg-white rounded-lg shadow-md overflow-hidden">
      <div className="bg-linear-to-r from-[#d5dce8] via-[#b8c5dc] to-[#8498bc] px-4! md:px-8! py-4! md:py-5!">
        <h2 className="text-lg! font-bold text-gray-900">Select Broker File</h2>
      </div>

      <div className="bg-white px-4! md:px-8! py-6! md:py-8!">
        <h3 className="text-lg! md:text-xl! font-bold text-gray-900 mb-5! md:mb-6!">
          Instruction to Download
        </h3>

        <div className="border border-gray-200 rounded-xl p-4 md:p-6 flex items-center justify-center flex-col mb-6 min-h-30 md:min-h-33">
          <img
            src={brokerImageSrc}
            alt={broker.name}
        ...
        <p className="text-sm! md:text-md! leading-relaxed text-gray-800 mb-4 mt-3!">
        ...
        <ol className="list-decimal pl-6 md:pl-10 text-sm! md:text-md! text-gray-800 leading-normal space-y-1 mb-6!">
        ...
        <p className="text-sm! md:text-md! text-gray-500 mb-6">
        ...
        <input
          ...
          type="file"
          accept=".xls,.xlsx"
          className="w-full my-4! border border-gray-300 rounded-md text-sm! md:text-base! text-gray-700 file:mr-3 md:file:mr-5 file:border-0 file:border-r file:border-gray-300 file:bg-blue-50 file:text-blue-600 file:px-4 md:file:px-6 file:py-3"
        />

        <button
          type="button"
          onClick={onBack}
          className="mt-8 md:mt-10 text-gray-500 hover:text-blue-600 text-sm!"
        >
          ‹ Previous step
        </button>
      </div>
