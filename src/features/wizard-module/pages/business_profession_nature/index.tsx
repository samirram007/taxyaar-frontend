...
const BusinessProfessionNature = () => {
                        ...
                        <div className="grid grid-cols-1 justify-center items-start gap-6 pb-6">
                            <div className='border-b-2 p-6 text-2xl'>
                                ...
                                <div className="text-sm text-muted-foreground">
                                    If more than one business/profession indicate the three main activities/products. (Other than those declaring income unser sections 44AD, 44ADA and 44AE)
...
export default BusinessProfessionNature
