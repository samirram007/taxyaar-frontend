...
const questions = [

    {
        ...
        question: "Is this a New / First (Original) Income-tax return for the Income earned between 1st April 2024 and 31st March 2025 that you are filing this year?",
        description: "",
        answer: [
            {
                "key": "yes",
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8  ">
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-24">
                <div className="grid grid-rows-1   lg:col-span-2">
                    <div className="lg:col-span-2 grid grid-cols-1 bg-white
                                        ...
                                        <div>
                                            ...
                                            <div className="p-4 bg-yellow-50 border border-yellow-200 rounded">
                                                <p className="text-sm text-yellow-800">
                                                    If revised, then enter following details of Original Return filed.:
                                                </p>
                                            </div>
