        ...
        <footer className="c-footer-w">
            <div className="container grid-footer">
                ...
                <div className="c-footer-bottom space-x-0  ">
                    <p className=" "> 2025-26 © Taxyaar Pvt. Ltd. | <span>All Rights Reserved</span> </p>
                </div>
                <div className=" disclaimer">  Disclaimer: File your Income Tax Return online with Taxyaar. E-filing through myitreturn is quick, safe, and
                    ...
                    smoothest and most secure filing experience. We are <a href="#">taxyaar.com</a>.</div>
