...
const FinancialEquityAndDebtInterestAdd = () => {
  const router = useRouter()
  const { addEquity } = useFinancialEquity()
            ...
            <div className={cardClassName}>
              <div className="border-b-2 p-6 text-2xl">
                ...
                <div className="text-sm text-muted-foreground">
                  Enter Details of Financial Equity and Debt Interest
                </div>
              </div>
...
export default FinancialEquityAndDebtInterestAdd
