...
const ForeignImmovableProperty = () => {
  const { properties, deleteProperty } = useImmovableProperties()
      ...
      <div className="grid lg:grid-cols-3 gap-8 mb-24">
        <div className="grid grid-rows-1   lg:col-span-2">
          ...
          >
            <div className="grid grid-cols-1 justify-center items-start gap-6 pb-6">
              <div className="border-b-2 p-6 text-2xl">
                ...
                <div className="text-sm text-muted-foreground">
                  Manage your Foreign Assets: Immovable Property details
                </div>
              </div>
              ...
              {properties && properties.length > 0 ? (
                <div className="px-6">
                  <div className="flex justify-end mb-4">
                    ...
                    >
                      <Link
                        to={'/foreign_immovable_property/add'}
                      ...
                      {properties &&
                        properties.map((row) => (
                          <TableRow key={row.id}>
                            ...
                            <TableCell>{row.addressOfProperty}</TableCell>
                ...
                <div className="space-y-1 px-6 flex flex-col items-center gap-4">
                  <p>Add your foreign immovable property details</p>
                  <p>
                    <Button
                      asChild
                      className="bg-teal-600 hover:bg-teal-700 transition-all duration-200 ease-out hover:shadow-lg hover:-translate-y-px active:scale-[0.97] cursor-pointer"
            ...
            <WizardFooter
              previousPageLink="/foreign_financial_entity"
              previousPageName="Foreign Financial Entity"
              nextPageLink="/foreign_other_assets"
              nextPageName="Foreign Assets"
              progress={{ percentage: '75%', remaining: '4 min more' }}
            />
          </div>
        </div>
        <HelpSidebar />
...
export default ForeignImmovableProperty
